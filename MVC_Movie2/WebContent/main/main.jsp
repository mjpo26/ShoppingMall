...
//                                       out.println(i);
                                         ...
                                         <div class="col-lg-3 col-sm-6">
                                            <div class="single_product_item">
                                                <img src="./assets/img/product/single-product/<%=recommendProduct.get(i).getItem_pic1() %>" alt="" 
                                                ...
                                                <div class="single_product_text">
                                                    ...
                                                    <a href="./basket.sh?Item_code=<%=recommendProduct.get(i).getItem_code()%>" class="add_cart">+ add to cart<i class="ti-heart"></i></a>
                                                    <a href="./wish.sh?Item_code=<%=recommendProduct.get(i).getItem_code()%>" class="add_cart"></a>
                                                </div>
                                            </div>
                                        </div>
                                        <%    
