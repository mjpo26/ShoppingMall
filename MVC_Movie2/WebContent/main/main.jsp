		...
		<div class="row align-items-center justify-content-between">
			<div class="col-lg-7 col-sm-6">
				<div class="single_feature_post_text">
					...
					<a href="#" class="feature_btn">EXPLORE NOW <i
						...
						src="./assets/img/feature/feature_1.png" alt="">
				</div>
			</div>
			<div class="col-lg-5 col-sm-6">
				<div class="single_feature_post_text">
					...
					<a href="#" class="feature_btn">EXPLORE NOW <i
						class="fas fa-play"></i></a> <img
						src="./assets/img/feature/feature_2.png" alt="">
				</div>
			</div>
			<div class="col-lg-5 col-sm-6">
				<div class="single_feature_post_text">
					...
					<a href="#" class="feature_btn">EXPLORE NOW <i
						class="fas fa-play"></i></a> <img
						src="./assets/img/feature/feature_3.png" alt="">
				</div>
			</div>
			<div class="col-lg-7 col-sm-6">
				<div class="single_feature_post_text">
					...
					<a href="#" class="feature_btn">EXPLORE NOW <i
						class="fas fa-play"></i></a> <img
						src="./assets/img/feature/feature_4.png" alt="">
				</div>
			</div>
		</div>
	</div>
