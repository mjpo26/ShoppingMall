			...
			<div class="review_content col-lg-8 mx-auto mt-5 p-5">
				<form action="./ReviewBoardWritePro.re" method="post"
					...
					<input type="hidden" name="order_item_code"
						value=<%=OrderBean.getOrder_item_code()%>> <input
						type="hidden" name="order_item_name"
						value=<%=OrderBean.getOrder_item_title()%>>


					<h3 class="mb-30"><%=OrderBean.getOrder_item_title()%>
						- 리뷰 작성
					</h3>
					<table class="table">
						<tr>
						...
						<tr>
							...
							<td><input type="password" name="review_pass"
								class="form-control" placeholder="글을 수정,삭제할때 입력할 비밀번호를 입력하세요"></td>
						...
						<tr>
							<td>첨부파일</td>
							<td colspan="3"><input type="file" name="review_file1"
						...
						<tr>
							...
							<td><input type="radio" name="review_starPoint" value="1">&nbsp;
								...
								name="review_starPoint" value="3">&nbsp; <span
								class="review_score"><i class="fa fa-star"></i><i
									class="fa fa-star"></i><i class="fa fa-star"></i></span> <input
								type="radio" name="review_starPoint" value="4">&nbsp; <span
								class="review_score"><i class="fa fa-star"></i><i
