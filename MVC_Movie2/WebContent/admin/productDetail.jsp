...
<div class="product_image_area section_padding">
	<div class="container">
		<!-- 이건 중요함 꼭 넣어야함 페이지에서 중앙 위치page asdf -->
		<form method="get" name="orderForm" onsubmit="return check()">
			...
			<input type="hidden" name="Item_sel_price"
				...
				type="hidden" name="Item_old_price"
				value=<%=itemBean.getItem_old_price()%>> <input
				type="hidden" name="Item_point" value=<%=itemBean.getItem_point()%>>
				...
				<div class="col-lg-5 col-xl-4">
					<div class="s_product_text">
						...
						<div class="item-info">
							...
							<h5 class="oneprice">
								<fmt:formatNumber value="<%=itemBean.getItem_old_price()%>" pattern="#,###" />
							</h5>
							<h2>
							<fmt:formatNumber value="<%=itemBean.getItem_sel_price()%>" pattern="#,###" />
	
<%-- 							<%=itemBean.getItem_sel_price()%> --%>
							</h2>
							<h6>
								적립금 :
							<fmt:formatNumber value="<%=itemBean.getItem_point()%>" pattern="#,###" />원
								<%-- 								<%=itemBean.getItem_point()%> --%>
							</h6>
							<%
						...
						<div
							...
							<div class="product_count">
								...
								<input class="input-number" type="text" id="Item_code_count"
									name="Item_code_count" value="1" min="0" max="10"> <span
						...
						<div
							...
							<input type="submit" value="장바구니 담기"
								formaction="./BasketInsert.bl" class="btn_3"> <input
								type="submit" value="즉시구매" formaction="order.sh"
								class="btn_3 buy"> <a href="#" class="like_us"
								onclick="./wish.sh"> <i class="ti-heart"></i>
							</a>
						</div>
						<%
							}
	...
	<div class="container">
		<ul class="nav nav-tabs" id="myTab" role="tablist">
			<li class="nav-item"><a class="nav-link" id="home-tab"
				...
				aria-selected="true">제품 설명</a></li>
			<li class="nav-item"><a class="nav-link" id="profile-tab"
				data-toggle="tab" href="#profile" role="tab" aria-controls="profile"
				aria-selected="false">상세 스펙</a></li>

			<li class="nav-item"><a class="nav-link active" id="review-tab"
				data-toggle="tab" href="#review" role="tab" aria-controls="review"
				aria-selected="false">제품 후기</a></li>
		</ul>
					...
					<div class="product_reivew clearfix">
						...
						<div class="col-12 review_list mb-4 float-left">
							<div class="review_title clearfix">
								...
								<p class="float-right">
									작성자 :
									<%=articleList.get(i).getReview_writer()%>
									&nbsp;&nbsp;&nbsp; 별점 :
									<%
							...
							<div class="bg-light p-3 review_bg" id="review_summary<%=i%>"
								onclick="doDisplay(<%=i%>);">
								<div class="review_summary">
									<p class="float-left d-inline-block"><%=articleList.get(i).getReview_content()%></p>
								</div>
								<i class="ti-angle-down float-right d-inline-block review_more"
									onclick="doDisplay(<%=i%>);"></i>
							</div>
							<div class="bg-light p-3 review_detail review_bg"
								id="review_detail<%=i%>" style="display: none;"
								onclick="doDisplay(<%=i%>);">
								<div class="review_content clearfix row">
									...
									<div class="review_text float-right d-inline-block col-9">
										<i class="ti-angle-up float-right d-inline-block review_more"
											onClick="doDisplay(<%=i%>);"></i>
										<p class="p-3">
						...
						<div id="pageList" class="text-center review_board board_paging">
							...
							%>
							<a
								href="productReview.sh?Item_code=<%=itemBean.getItem_code()%>&page=<%=review_nowPage - 1%>">
							...
							%>
							<a
								href="productReview.sh?Item_code=<%=itemBean.getItem_code()%>&page=<%=i%>">
								<%=i%>&nbsp;
							</a>
							<%
								}
							...
							%>
							<a
								href="productReview.sh?Item_code=<%=itemBean.getItem_code()%>&page=<%=nowPage + 1%>">&nbsp;&nbsp;&nbsp;
