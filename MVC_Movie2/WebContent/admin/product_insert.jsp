			...
			<section class="content product_insert">			
				<form action="./ItemInsert.sh" method="post" name="fr" enctype="multipart/form-data">
				   <div class="content_title">				
					...
					<tr>
						<th>판매가(필수)</th>
						<td><input type="text" name="old_price"> 할인율 : 
						<input type="text" name="sale_price" >%</td>
					...
					<tr>
						<th>상품상세설명</th>
						<td><textarea id="summernote" name="content2"></textarea></td>
					...
					<tr>
						...
						<input type="radio" name="sales" value="no">판매안함</td>
					</tr>
