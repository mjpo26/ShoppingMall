...
<article id="content">
	<div class="container mainDiv">
		...
		<form action="./AdminBoardList.me" name="fr1" method="post"
			...
			<table class="table">
				<tr>
					...
					<td>시작날짜:&nbsp;&nbsp;<input type="text" name="pickStart"
						...
						type="text" name="pickEnd" id="pickEnd">
					</td>
				</tr>
				<tr>
					<th>게시판 선택 *필수*</th>
...
<!-- 							<option value="">선 택</option> -->
				...
				<tr>
					...
					<td><input type="text" size="20" name="title"
						placeholder="제목으로 검색"> <input type="text" size="20"
						name="writer" placeholder="작성자로 검색"></td>
				</tr>

				<tr>
					<th>답변여부</th>
					<td><input type="radio" name="replyCheck" value="*">전체
						<input type="radio" name="replyCheck" value="0">답변전 <input
						type="radio" name="replyCheck" value="1">답변완료</td>
				</tr>
			</table>
		...
		<!-- 리뷰게시판 게시판!!!!!!!!!!!!!! -->
		<%
			if (abb.getBoard_list().equals("리뷰게시판")) {
