...
<!-- 날짜선택 스크립트 끝 -->
    ...
    <article id="content">
    	<div class="container mainDiv">
		   <form action="./Admin_memberList.me" name="fr1" method="post" onsubmit="return pickNullCheck()">
		      ...
		      <table class="table">
		         ...
		         <tr>
		            <th>sms수신</th>
		            	<td><input type="radio" name="smsOk" value="ok">수신허용<input type="radio" name="smsOk" value="no">수신안함</td>
		
		         </tr>
		         <tr>
		            <th>email수신</th>
		            	<td><input type="radio" name="emailOk" value="ok">수신허용<input type="radio" name="emailOk" value="no">수신안함</td>
		         </tr>
		         <tr>
		         	<th>날짜 설정</th>
