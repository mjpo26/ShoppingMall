		...
		<form action="QnA_BoardWritePro.qa" method="post" enctype="multipart/form-data" name="boardform">
			<table>
				<tr>
					...
					<td class="td_right"><input type="text" name="QnA_writer_id" id="QnA_writer_id" value="<%=sId %>"  readonly="readonly" required="required" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="td_right"><input type="file" name="QnA_file1" id="QnA_file1" /></td>
				</tr>
			</table>
