				...
				<table class="table">
					...
					<tr>
						...
						<td width="200" align="center" colspan="2">
							<fmt:formatNumber value="<%=itemBean.getItem_point() * item_code_count%>"	pattern="#,###" />원
						</td>
						<th width="200" align="center">가격</th>
						<td width="200" align="center" colspan="2">
							<fmt:formatNumber value="<%=itemBean.getItem_sel_price() * item_code_count%>"	pattern="#,###" />원
						</td>
					...
					<tr>
						<td align="right" colspan="6"><input type="text"
							...
							style="padding-left: 0.5em;">사용이 안됩니다.</span> <input
							type="hidden" id="usedOk" value="no"></td>
