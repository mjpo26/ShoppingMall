...
import action.Free_BoardDetailAction;
import action.Free_BoardListAction;
import action.Free_BoardModifyFormAction;
import action.Free_BoardModifyProAction;
import action.Free_BoardReplyFormAction;
import action.Free_BoardReplyProAction;
import action.Free_BoardWriteProAction;
import vo.ActionForward;

// 서블릿 주소가 XXX.bo 로 끝나는 주소들을 모두 매핑
// ex. BoardList.bo, BoardWriteForm.bo 등
@WebServlet("*.bo")
public class Free_BoardFrontController extends HttpServlet {
...
//        System.out.println(command);
        ...
        } else if(command.equals("/Free_BoardWriteForm.bo")) {
            forward = new ActionForward();
            forward.setPath("/free_board/Free_board_write.jsp");
        } else if(command.equals("/Free_BoardWritePro.bo")) {
            // Action 인터페이스를 구현한 XXXAction 클래스의 인스턴스를 생성하여
            // execute() 메서드를 호출하여 요청 작업을 처리한 후 ActionForward 객체 리턴받아야 한다.
            action = new Free_BoardWriteProAction(); // Action 클래스 인스턴스 생성
        ...
        } else if(command.equals("/Free_BoardList.bo")) {
            action = new Free_BoardListAction();
        ...
        } else if(command.equals("/Free_BoardDetail.bo")) {
            action = new Free_BoardDetailAction();
        ...
        } else if(command.equals("/Free_BoardReplyForm.bo")) {
            action = new Free_BoardReplyFormAction();
        ...
        } else if(command.equals("/Free_BoardModifyForm.bo")) {
            action = new Free_BoardModifyFormAction();
        ...
        } else if(command.equals("/Free_BoardModifyPro.bo")) {
            action = new Free_BoardModifyProAction();
        ...
        } else if(command.equals("/Free_BoardReplyPro.bo")) {
            action = new Free_BoardReplyProAction();
        ...
        } else if(command.equals("/Free_BoardDeleteForm.bo")) {
            forward = new ActionForward();
            forward.setPath("/free_board/Free_board_delete.jsp");
        } else if(command.equals("/Free_BoardDeletePro.bo")) {
            action = new Free_BoardDeleteProAction();
