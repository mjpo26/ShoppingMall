...
public class Free_BoardDAO {
    ...
    private static Free_BoardDAO instance;
    ...
    public int insertArticle(Free_BoardBean article) throws Exception {
        ...
        try {
            ...
            // free_writer_id, free_pass, free_subject, free_content, free_file1 - BoardBean 객체 값 사용
            ...
            pstmt.setString(6, article.getFree_file1());
            ...
            //12번 라인은 date
            pstmt.setString(12, article.getFree_file2());
            pstmt.setString(13, article.getFree_file3());
            pstmt.setString(14, article.getFree_file4());
            pstmt.setString(15, article.getFree_file5());
...
//            e.printStackTrace();
          ...
          System.out.println("보드디에오,아티클 안에는 값 들어가있나"+article.getFree_subject());
