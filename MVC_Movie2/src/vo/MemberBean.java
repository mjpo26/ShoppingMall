...
public class MemberBean {
  ...
  private String member_email_ok;
   ...
   int member_mypoint;
   int member_yechimoney;
   String member_grade;
   int member_used_point;
   String member_postcode1;
   String member_postcode2;
   String member_postcode3;
   String member_postcode4;
   String member_postcode5;
   String member_address_x1;
   String member_address_y1;
   String member_address_x2;
   String member_address_y2;
   String member_address_x3;
   String member_address_y3;
   String member_address_x4;
   String member_address_y4;
   String member_address_x5;
   String member_address_y5;
