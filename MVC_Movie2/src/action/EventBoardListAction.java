...
public class EventBoardListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        System.out.println("EventBoardListAction 실행됨");
        // 페이징 처리를 위한 변수 선언
        int page = 1; // 현재 페이지
        int limit = 12; // 한 페이지 당 표시할 게시물 수
        ...
        EventBoardListService boardListService = new EventBoardListService();
